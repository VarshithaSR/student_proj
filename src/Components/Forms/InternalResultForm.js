    ...
    <main className="internal">
      ...
      <section className="form__head">
        <form className="w-full gap-4 accent-orange-900 md:flex">
          <select
            className="mb-4 block h-10 w-full rounded-md border-[1.5px] border-solid border-slate-400 p-1 pl-2 outline-none selection:border-slate-200 focus:border-orange-900 dark:border-slate-200 dark:caret-inherit dark:focus:border-orange-400 dark:active:border-orange-400 md:w-1/3"
        ...
        <form className="internal__body__form">
                  ...
                  {internal?.map((student, index) => (
                    <tr
                      ...
                      className={
                        ...
                        7
                          ? "border-t-[1px] border-slate-400 bg-orange-900/50 first:border-none"
          ...
          {internal.length && disabled ? (
            <div className="flex gap-4">
              ...
              <button
                type="submit"
                className="mb-4 flex h-10 w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-orange-900 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-red-700 focus:bg-orange-900 dark:border-orange-300 dark:bg-orange-900 dark:text-orange-100 dark:hover:bg-red-700"
